					...
					<div class="row">
						<div class="col-md-8">
							<div class=" section"></div>
								...
								if(count($posts) > 0){
									echo "
									<h3>Index Analisis <span class=\"text-default\">Terbaru</span></h3>
                    ...
                    <div class=\"blog-item\">
											<div class=\"row\">
												<div class=\"col-xs-12 col-sm-4 text-center\">";
													if($sampul != ""){
														echo "<a href=\"".$post_url."\"><img class=\"img-responsive\" src=\"".$sampul."\" width=\"100%\" alt=\"\" /></a>";
													}
													echo "
													
													<div class=\"entry-meta\">
														<span id=\"publish_date\">".indonesian_date(strtotime($item["post_date"]),"j F","")."</span>
														<span><i class=\"fa fa-user fa-fw\"></i><a href=\"#\">".$item["unama"]."</a></span>
														<span><i class=\"fa fa-comment fa-fw\"></i><a href=\"".$post_url."#comments\">".$item["comment_count"]." Komentar</a></span>
														<span><i class=\"fa fa-heart fa-fw\"></i><a href=\"#\" class=\"suka\" id=\"suka_".$item["ID"]."\"><strong>".$item["post_like"]."</strong> Suka</a></span>
														<span><i class=\"fa fa-check-square-o fa-fw\"></i><a href=\"#\">".$item["post_klik"]."lihat</a></span>
													</div>
												</div>
														
												<div class=\"col-xs-12 col-sm-8 blog-content\">
													<h2><a href=\"".$post_url."\">".$item["post_title"]."</a></h2>
													<h3>".$abstrak."... <a class=\"readmore\" href=\"".$post_url."\">selengkapnya <i class=\"fa fa-angle-double	-right\"></i></a></h3>
